---
title: "Ladybug Tools is hiring for two open positions"
date: "2021-01-17 00:01:30"
lastmod: "2021-01-21 14:55:50"
slug: "ladybug-tools-is-hiring-for-two-open-positions"
draft: false
author: "Moult"
...
cover:
  image: "/uploads/2021/01/ladybug-tools-is-hiring-for-two-open-positions-radcity.png"
  alt: "Ladybug Tools is hiring for two open positions"
...
Ladybug Tools is looking for new team members to join our team. We’re a technology company providing software and consulting services for environmental building design and simulation. We create and maintain software for building simulation, including the well-known [Ladybug Tools](http://github.com/ladybug-tools/). We are currently building our next big thing - [Pollination](https://github.com/pollination/) - which you will be working on after joining the team! Pollination is a collaborative web platform for energy and environmental simulation. To learn more about Pollination, you can [watch our presentation](https://www.youtube.com/watch?v=eYXs6Dyz4xs) at the AEC Tech 2020 symposium.
...
- [Read the forum post looking for a new frontend developer](https://discourse.ladybug.tools/t/frontend-developer-position-at-ladybug-tools-remote/12275)
- [Read the forum post looking for a new backend developer](https://discourse.ladybug.tools/t/backend-developer-position-at-ladybug-tools-remote/12276)
- Visit the [project homepage](https://ladybug.tools)
- Help contribute to the [OSArch Wiki description](https://wiki.osarch.org/index.php?title=Ladybug_Tools) of the project
- Help port the tools to be [available on Blender](https://github.com/ladybug-tools/ladybug-blender)
