---
title: "Epic MegaGrants funding awarded to BlenderBIM Add-on"
date: "2021-05-25 10:52:50"
lastmod: "2021-05-25 10:52:53"
slug: "epic-megagrants-funding-awarded-to-blenderbim-add-on"
draft: false
author: "Moult"
...
cover:
  image: "/uploads/2021/05/epic-megagrants-funding-awarded-to-blenderbim-add-on-2.png"
  alt: "Epic MegaGrants funding awarded to BlenderBIM Add-on"
...
![Epic MegaGrants funding awarded to BlenderBIM Add-on](/uploads/2021/05/epic-megagrants-funding-awarded-to-blenderbim-add-on-2.png)

The BlenderBIM Add-on is an Epic MegaGrants recipient! Projects showcased here is from [OpeningDesign](http://openingdesign.com)'s [CC-BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) projects [223 Randolph St Atlanta](https://gitlab.com/openingdesign/223_randolph_st__atlanta) and [Heck Residence](https://gitlab.com/openingdesign/heck_residence)
...
Improved geometry processing will result in more stable support across a wide number of free software applications - with the BlenderBIM Add-on only being one of them. There are over [15 free and commercial applications](https://wiki.osarch.org/index.php?title=IfcOpenShell#Softwares_powered_by_ifcopenshell) in the industry and university courses that are powered by the underlying free and open source IfcOpenShell engine, like FreeCAD, BIMServer, Tridify, Augin, and more - so investments in free software will see compounded improvements across the industry and in BIM education.
...
- Learn more about [Epic MegaGrants](https://www.unrealengine.com/en-US/megagrants)
- Learn more about the [BlenderBIM Add-on](https://blenderbim.org/)
- Learn more about [IfcOpenShell](http://www.ifcopenshell.org/)
- Read through the [OSArch discussion leading to the grant application](https://community.osarch.org/discussion/165/application-to-epic-games-megagrants-for-the-blenderbim-add-on)
- Know how to code? Help us hack on the [IfcOpenShell Github Repository](https://github.com/IfcOpenShell/IfcOpenShell)
- Investing in free software benefits the entire industry. If you or your company wants to financially contribute, check out the [OpenSourceBIM Collective Fund](https://opencollective.com/opensourcebim)
