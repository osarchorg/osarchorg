---
title: "Tridify, an IFC data streaming service that supports open source"
date: "2021-02-08 14:59:37"
lastmod: "2021-02-08 14:59:38"
slug: "tridify-an-ifc-data-streaming-service-that-supports-open-source"
draft: false
...
cover:
  image: "/uploads/2021/01/tridify-an-ifc-data-streaming-service-that-supports-open-source.png"
  alt: "Tridify, an IFC data streaming service that supports open source"
  hiddenInSingle: false
  hiddenInList: false
---
Tridify is an IFC data streaming service to facilitate BIM models visualizations. With Tridify you can easily share and view IFC models in any web browser. Although it is a proprietary service, Tridify supports open source projects, according to Jukka Muhonen, Head of Production at Tridify:
...
- [Fortnite developer backs IFC data streaming service](https://www.bimplus.co.uk/news/fortnite-backs-ifc-streaming-service/).
- Tridify [official website](https://www.tridify.com/how-it-works/).
- IfcOpenShell [official website](http://ifcopenshell.org/).
